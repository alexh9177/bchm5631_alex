...
# around the center of the promoter window (TSS).
...
# combing on the same plot shows the difference in binding !
```
...
# Writing a for loop to calculate promoter coverage for all DBPs:
