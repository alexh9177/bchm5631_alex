...
#let's look at the promoter peak occurrence matrix (takes ~4 min to load)
promoter_peak_occurence_matrix <- read.table("/path/12_peak_features/lncrna_mrna_promoter_peak_occurence_matrix.tsv")
...
Let's get started by finding the 'distance' between each promoter vector.
