...
```
# writing custom function to retreive specific data from encode
...
# where we join the experiment accession and the rep number
samples <- samples %>%
...
# writing out md5$line col that has the command in it from above.
...
# md5_results <- system("cd 17_API_to_RNA/fastq; md5sum -c md5.txt", intern = TRUE)
...
base_path <- "/scratch/Shares/rinnclass/CLASS_2022/alhi9177/bchm5631_alex/CLASS_2022/class_exeRcises/analysis/17_API_to_RNA/fastq/"
