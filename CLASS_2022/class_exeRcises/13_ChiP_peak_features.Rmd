...
filtered_consensus_peaks_files <- list.files("/scratch/Shares/rinnclass/CLASS_2022/alhi9177/bchm5631_alex/CLASS_2022/class_exeRcises/analysis/11_consensus_peaks/filtered_consensus_peaks", 
                                             pattern = "*.bed",
                                             full.names = TRUE)
# filtered_consensus_peaks_files <- list.files("file_path", 
#                                              pattern = "*.bed",
#                                              full.names = TRUE)
# 
# 
...
# # adding names to rows
 names(filtered_consensus_peaks) <- gsub("file_path/|_filtered_consensus_peaks.bed","", filtered_consensus_peaks_files)
names(filtered_consensus_peaks) <- gsub("/scratch/Shares/rinnclass/CLASS_2022/alhi9177/bchm5631_alex/CLASS_2022/class_exeRcises/analysis/11_consensus_peaks/filtered_consensus_peaks/|_filtered_consensus_peaks.bed","", filtered_consensus_peaks_files)
```
...
lncrna_mrna_genebody <- rtracklayer::import("/scratch/Shares/rinnclass/CLASS_2022/alhi9177/bchm5631_alex/CLASS_2022/class_exeRcises/analysis/11_consensus_peaks/gene_annotation_files/lncrna_mrna_genebody.gtf")
...
write_csv(num_peaks_df, "/scratch/Shares/rinnclass/CLASS_2022/alhi9177/bchm5631_alex/CLASS_2022/class_exeRcises/analysis/12_ChiP_peak_features/num_peaks_df.csv")
```
...
destination_for_url <- "/scratch/Shares/rinnclass/CLASS_2022/alhi9177/bchm5631_alex/CLASS_2022/class_exeRcises/analysis/12_ChiP_peak_features/TF_annotations.xlsx"
...
human_tfs <- readxl::read_excel("/scratch/Shares/rinnclass/CLASS_2022/alhi9177/bchm5631_alex/CLASS_2022/class_exeRcises/analysis/12_ChiP_peak_features/TF_annotations.xlsx",
                                sheet = 2, skip = 1)
...
write.table(promoter_peak_occurence, "scratch/Shares/rinnclass/CLASS_2022/alhi9177/bchm5631_alex/CLASS_2022/class_exeRcises/analysis/12_ChiP_peak_features/lncrna_mrna_promoter_peak_occurence_matrix.tsv")
...
write_csv(peak_occurence_df, "scratch/Shares/rinnclass/CLASS_2022/alhi9177/bchm5631_alex/CLASS_2022/class_exeRcises/analysis/12_ChiP_peak_features/peak_occurence_dataframe.csv")
